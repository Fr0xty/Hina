module.exports = {
    ...
    convertSeconds: (seconds) => {
        return new Promise((resolve, reject) => {
            ...
            if (seconds <= 59) resolve(`${seconds}s`);
    ...
    convertMention: (client, mention) => {
        return new Promise((resolve, reject) => {
            
            if (!mention) reject('no mentions provided');
    ...
    convertFlags: (bitField) => {
        return new Promise((resolve, reject) => {

            let flags = [];
            if (bitField == 0) resolve('None');
