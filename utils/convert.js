module.exports = {
    ...
    convertMention: async (client, mention) => {
    ...
    convertPresence: async (presence) => {
    ...
    convertPermissions: async (bitField) => {
