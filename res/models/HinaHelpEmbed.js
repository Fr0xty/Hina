...
\u2800
            `)
            .addFields(
                {name: 'SFW', value: '`waifu`, `uniform`, `maid`, `marin-kitagawa`, `mori-calliope`, `raiden-shogun`, `selfies`, `neko`, `shinobu`, `megumin`, `awoo`\n\u2800'},
                {name: 'NSFW', value: '`ass`, `ecchi`, `ero`, `hentai`, `milf`, `oral`, `paizuri`, `breast`, `nsfwmaid`, `nsfwuniform`, `nsfwwaifu`, `nsfwselfies`, `nsfwneko`, `trap`, `blowjob`\n\u2800\n\u2800'},
