...
[**${timestamp.progress}**%]
                `)
            .addFields({ name: 'Source', value: npMusic.source }, { name: 'Artist', value: npMusic.author }, { name: 'Views', value: String(npMusic.views) }, { name: 'Requested by', value: `<@${npMusic.requestedBy.id}>` });
